...
class __TwigTemplate_b7e12a6845296191e9256c778a7b33845eaeb2a5b8e09b2df4f51d6a9c699d7f extends Twig_Template
{
...
($context["csvKBLink"] ?? null), "wrongFileFormat" => $this->env->getExtension('MailPoet\Twig\I18n')->translate("Only comma-separated (CSV) file formats are supported."), "maxPostSizeNotice" => twig_replace_filter($this->env->getExtension('MailPoet\Twig\I18n')->translate("Your CSV is over %s and is too big to process. Please split the file into two or more sections."), array("%s" =>         // line 40
...
";
    ...
    {
        return new Twig_Source("", "subscribers/importExport/import.html", "/home/docsduno/www/wp-content/plugins/mailpoet/views/subscribers/importExport/import.html");
    }
}
