...
class __TwigTemplate_38a42e4d3e95ecb739deadc3bff1b460fce4e243eb78d02f044533122ba8e419 extends Twig_Template
{
...
<input type=\"text\" disabled=\"disabled\" value=\"\" placeholder=\"{{#if params.label_within}}{{ params.label }}{{#if params.required}} *{{/if}}{{/if}}\" />";
    ...
    {
        return new Twig_Source("", "form/templates/blocks/text.hbs", "/home/docsduno/www/wp-content/plugins/mailpoet/views/form/templates/blocks/text.hbs");
    }
}
